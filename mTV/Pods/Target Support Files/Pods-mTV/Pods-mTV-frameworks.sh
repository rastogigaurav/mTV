...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "$BUILT_PRODUCTS_DIR/ActionSheetPicker-3.0-iOS10.0/ActionSheetPicker_3_0.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/SWRevealViewController-iOS10.0/SWRevealViewController.framework"
fi
