...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "$BUILT_PRODUCTS_DIR/ActionSheetPicker-3.0-iOS10.3/ActionSheetPicker_3_0.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/SWRevealViewController-iOS10.3/SWRevealViewController.framework"
fi
